                                                    ...
                                                    <div className="space-y-4">
                                                        ...
                                                        <div className="grid grid-cols-2 gap-4">
                                                            ...
                                                            <div className="space-y-1">
                                                                ...
                                                                <input type="number" min="0" value={newAuto.stepId === step.id ? newAuto.dueDaysOffset : 1} onChange={e => setNewAuto({...newAuto, stepId: step.id, dueDaysOffset: parseInt(e.target.value) || 0})}
                                                                    className="w-full border border-gray-100 rounded-xl px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none bg-white" />
                                                            </div>
                                                        </div>
